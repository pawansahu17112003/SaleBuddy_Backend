...
router.post("/orders_submit", function (req, res, next) {
  pool.query(
    ...
    [req.body.orderdate, req.body.ordertime, req.body.totalamount, req.body.mobileno, req.body.emailid, req.body.status, req.body.paymentmode, req.body.transactionid],
...
router.post("/insert_orderdetails", function (req, res, next) {
  q = "insert into orderdetails (orderid, mobileno, productdetailsid, price, offerprice, amount, qty, deliverystatus, address, city, state, paymentstatus, productname)values ?";
  pool.query(
    q, [
